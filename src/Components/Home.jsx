    ...
    <div id="home">
      ...
      <div className="flex flex-row bg-black text-white p-32">
        <div>
          ...
          <div className="text-2xl">
            Helping startup founders to design thoughtful digital products that
        ...
        <div className="grid md:grid-cols-2">
          <div className="flex flex-col justify-center content-center">
            ...
            <div className="text-xl">
              1-on-1 engagements with a professional designer that will help you
              to solve critical problems for you in your business and map out an
              entire experience for your product launch.
            </div>
          </div>
          <div>
            <img src={jmstars} alt="" />
      ...
      <div className="grid md:grid-cols-2">
        <div className="p-32">
          ...
          <div className="text-xl">With 5+ years of experience in helping founders to communicate their vision for digital products. Jonathan leverages user-centered design approaches that focus on improving the user journey through a web/mobile app experience with the intention of increasing the quality of the user interaction.</div>
          <div className="text-blue-500">More About JM</div>
        </div>
        <div className="p-32"><img src={jmthumb} alt=""/></div>
      </div>
    </div>
    </div>
  );
